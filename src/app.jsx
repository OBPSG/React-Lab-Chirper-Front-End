...
function App() {
    ...
    return (
        <div className="container">
            ...
            <form className="form-group mt-4 col-md-9" onSubmit={handleSubmit}>
                ...
                <textarea value={postText} onChange={(event) => setPostText(event.target.value)} type="text" className="form-control mt-2" placeholder="Post Text Here..."></textarea>
                <input type="submit" value="Post" className="btn mt-2 px-5 bg-success text-white float-end"></input>
            </form>
        </div>
    );
}
